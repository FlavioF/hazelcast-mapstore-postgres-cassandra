...
public class HCPostgresMapStore implements MapStore<String, String> {

  static final Logger log = LoggerFactory.getLogger(HCPostgresMapStore.class);
  ...
  public EventEntityDao getDao() {
    return dao;
  }

  public void setDao(EventEntityDao dao) {
    this.dao = dao;
  }
